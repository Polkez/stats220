...
Pretty straightforward answer since the rating median is way lower for the No group than the Yes group.

# Conclusion
The story theme here is that social media is terrible for me, especially when I use it after midnight and I do use it a lot after midnight. I rate lower when it is time in the morning (or after midnight), and when I should not use social media.

So it is a good idea to not use social media after mightnight and just sleep.
